...
> The latest [**Skills Tree**](https://owq9eirkwt.feishu.cn/base/bascnNz4Nqjqgqm1Nm5AYke6xxb).
...
You need to copy the **Skill IDs** from the latest [**Skills Tree**](https://owq9eirkwt.feishu.cn/base/bascnNz4Nqjqgqm1Nm5AYke6xxb), and paste it into the `index.json`:
