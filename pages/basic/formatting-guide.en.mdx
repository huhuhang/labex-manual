...
1. Images may increase the size of the document, thus increasing download time.
2. Images cannot be easily analyzed by large language models, and our document content is transmitted to the language model for learning assistant Labby to better assist users.

We recommend that you:

1. Try to convert the content expressed in images to text. For example, use markdown code blocks to display terminal input and output information, execution results, etc.
2. If images are necessary, describe them using text paragraphs so that large language models can understand the content of the images.
