    ...
    "steps": [
      {
        ...
        "solutions": ["solution1.md", "solution2.py"]
...
5. `solutions`: (challenge 必选，lab 缺省) challenge 的每个步骤均需要配置**相应步骤**的解决方案（答案），通过 list 列表绑定本地 `solutions` 文件夹中的 md 文件、代码文件，文件请务必放在 `solutions` 文件夹中。
