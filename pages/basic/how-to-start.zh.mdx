...
<iframe src="//player.bilibili.com/player.html?bvid=BV1uv4y1t7wx&page=1" width="100%" height="600" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"> </iframe>
...
5. `difficulty`: 难度，必须为 `Beginner`，`Intermediate` 或者 `Intermediate`。
