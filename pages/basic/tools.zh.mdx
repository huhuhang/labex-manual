...
> 你也可以使用 GitHub 提供的在线 Visual Studio Code。试着把 repo URL `https://github.com/labex-labs/scenarios` 改为 `https://github.dev/labex-labs/labex-candidate`，你会看到和桌面版一样的界面。
