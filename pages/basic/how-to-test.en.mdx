...
When conducting online testing of content, especially after reviewing and making changes to annotation issues, it is necessary to conduct a complete round of online testing to ensure that you have modified similar problems or discovered new ones during the test.

You must be responsible for the content you produce. Your content will ultimately be delivered to users. If there are quality issues with your content, it will mislead users.

Here I suggest that everyone adopt the "zeroing" principle, which means starting from scratch. That is, when modifications are made to the content, a complete round of online testing should be conducted again for confirmation.
