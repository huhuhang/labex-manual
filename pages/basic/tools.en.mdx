...
> You can also use the Online Visual Studio Code provided by GitHub. Try to change the repo URL `https://github.com/labex-labs/scenarios` to `https://github.dev/labex-labs/labex-candidate`, and you will see the same interface as the desktop version.
